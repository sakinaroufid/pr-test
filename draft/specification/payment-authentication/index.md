...
These Action types use the parent Checkout lifecycle defined in [Checkout — Actions](https://sakinaroufid.github.io/pr-test/draft/specification/checkout/#actions):
...
- [Payment Device Data Collection](https://sakinaroufid.github.io/pr-test/draft/specification/payment-actions/device-data-collection/index.md)
- [Payment 3DS Challenge](https://sakinaroufid.github.io/pr-test/draft/specification/payment-actions/three-ds-challenge/index.md)
