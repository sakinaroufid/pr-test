...
This document specifies the Model Context Protocol (MCP) binding for the [Catalog Capability](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/index.md).
...
| ---------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ |
| `search_catalog` | [Search](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/search/index.md)                 | Search for products.                                   |
| `lookup_catalog` | [Lookup](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/lookup/index.md)                 | Lookup one or more products or variants by identifier. |
| `get_product`    | [Lookup](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/lookup/#get-product-get_product) | Get full product detail by identifier.                 |
...
Maps to the [Catalog Lookup](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/lookup/#get-product-get_product) capability. Returns a singular `product` object for full product detail with interactive option selection.
...
All application-level outcomes return a successful JSON-RPC result with the UCP envelope and optional `messages` array. See [Catalog Overview](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/#messages-and-error-handling) for message semantics and common scenarios.
...
1. Implement tools for each catalog capability advertised in the business's UCP profile, per their respective capability requirements ([Search](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/search/index.md), [Lookup](https://sakinaroufid.github.io/pr-test/draft/specification/catalog/lookup/index.md)). Each capability may be adopted independently. When the Lookup capability is advertised, both `lookup_catalog` and `get_product` tools MUST be available.
