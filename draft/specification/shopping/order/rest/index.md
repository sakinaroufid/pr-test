...
This document specifies the REST binding for the [Order Capability](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/index.md).
...
For the Order Event Webhook (business -> platform push), see the [Order Capability overview](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/#order-event-webhook).
...
See [Order Capability - Guidelines](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/#operations-guidelines) for capability-level requirements that apply across all transports.
