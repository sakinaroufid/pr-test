...
This document specifies the Model Context Protocol (MCP) binding for the [Order Capability](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/index.md).
...
| ----------- | ------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `get_order` | [Get Order](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/#get-order) | Get the current state of an order. |

### `get_order`

Maps to the [Get Order](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/order/#get-order) operation. Returns the current-state snapshot of an order.
...
- **MUST** implement the `get_order` tool per the [OpenRPC schema](/pr-test/draft/services/shopping/mcp.openrpc.json)
