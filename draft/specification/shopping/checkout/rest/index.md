...
This document specifies the REST binding for the [Checkout Capability](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/index.md).
...
| -------------------------------------------------------------------------------------------------------------------- | ------ | ---------------------------------- | -------------------------- |
| [Create Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#create-checkout)     | `POST` | `/checkout-sessions`               | Create a checkout session. |
| [Get Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#get-checkout)           | `GET`  | `/checkout-sessions/{id}`          | Get a checkout session.    |
| [Update Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#update-checkout)     | `PUT`  | `/checkout-sessions/{id}`          | Update a checkout session. |
| [Complete Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) | `POST` | `/checkout-sessions/{id}/complete` | Place the order.           |
| [Cancel Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#cancel-checkout)     | `POST` | `/checkout-sessions/{id}/cancel`   | Cancel a checkout session. |
...
The response is the Checkout object; the example below shows the synchronous `completed` case. See core [Complete Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) for status and `order` semantics.
