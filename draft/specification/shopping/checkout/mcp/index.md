...
This document specifies the Model Context Protocol (MCP) binding for the [Checkout Capability](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/index.md).
...
The `meta["ucp-agent"]` field is **required** on all requests to enable [capability negotiation](https://sakinaroufid.github.io/pr-test/draft/specification/overview/#negotiation-protocol). The `complete_checkout` and `cancel_checkout` operations also require `meta["idempotency-key"]` for retry safety. Platforms **MAY** include additional metadata fields.
...
| ------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| `create_checkout`   | [Create Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#create-checkout)     | Create a checkout session. |
| `get_checkout`      | [Get Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#get-checkout)           | Get a checkout session.    |
| `update_checkout`   | [Update Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#update-checkout)     | Update a checkout session. |
| `complete_checkout` | [Complete Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) | Place the order.           |
| `cancel_checkout`   | [Cancel Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#cancel-checkout)     | Cancel a checkout session. |

### `create_checkout`

Maps to the [Create Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#create-checkout) operation.

#### Input Schema

- `checkout` ([Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#create-checkout)): **Required**. Contains the initial checkout session data and optional extensions.
  - Extensions (Optional):
    - `dev.ucp.shopping.buyer_consent`: [Buyer Consent](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/buyer-consent/index.md)
    - `dev.ucp.shopping.fulfillment`: [Fulfillment](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/fulfillment/index.md)
    - `dev.ucp.shopping.discount`: [Discount](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/discount/index.md)
    - `dev.ucp.common.payment.ap2_mandate`: [AP2 Mandates](https://sakinaroufid.github.io/pr-test/draft/specification/payment/extensions/ap2-mandates/index.md)

#### Output Schema

- [Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#create-checkout) object.
...
Maps to the [Get Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#get-checkout) operation.
...
- [Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#get-checkout) object.

### `update_checkout`

Maps to the [Update Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#update-checkout) operation.
...
- `checkout` ([Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#update-checkout)): **Required**. Contains the updated checkout session data.
  - Extensions (Optional):
    - `dev.ucp.shopping.buyer_consent`: [Buyer Consent](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/buyer-consent/index.md)
    - `dev.ucp.shopping.fulfillment`: [Fulfillment](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/fulfillment/index.md)
    - `dev.ucp.shopping.discount`: [Discount](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/extensions/discount/index.md)
...
- [Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#update-checkout) object.
...
Maps to the [Complete Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) operation.
...
- `id` (String): **Required**. The ID of the checkout session.
- `checkout` ([Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout)): **Required**. Contains payment credentials and other finalization data to execute the transaction.

#### Output Schema

- [Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) object. See core [Complete Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#complete-checkout) for status and `order` semantics.

### `cancel_checkout`

Maps to the [Cancel Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#cancel-checkout) operation.
...
- [Checkout](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/#cancel-checkout) object with `status: canceled`.
...
Platforms **SHOULD** authenticate agents when using MCP transport. When using HTTP Message Signatures, all checkout operations follow the [Message Signatures](https://sakinaroufid.github.io/pr-test/draft/specification/signatures/index.md) specification.
