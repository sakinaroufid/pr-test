...
This document specifies the Agent2Agent Protocol (A2A) binding for [Checkout Capability](https://sakinaroufid.github.io/pr-test/draft/specification/shopping/checkout/index.md).
