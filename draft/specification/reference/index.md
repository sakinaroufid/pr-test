...
| identity    | [Payment Identity](/pr-test/draft/specification/reference/#payment-identity) | Optional     | The participant this token is bound to. Required when acting on behalf of another participant (e.g., agent tokenizing for merchant). Omit when the authenticated caller is the binding target. |
...
| price     | [Amount](/pr-test/draft/specification/reference/#amount) | **Required**; omitted in requests | Unit price in ISO 4217 minor units.                                                                                                                                         |
...
| item      | [Item](/pr-test/draft/specification/reference/#item)            | **Required** | Product data (id, title, price, image_url).                                                                                                                                                                                                                         |
