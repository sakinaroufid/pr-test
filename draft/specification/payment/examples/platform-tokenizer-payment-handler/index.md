...
The handler accepts [PanCredential](/pr-test/draft/schemas/common/types/pan_credential.json) and [NetworkTokenCredential](/pr-test/draft/schemas/common/types/network_token_credential.json) for tokenization and produces [TokenCredential](/pr-test/draft/schemas/common/types/token_credential.json) for checkout.
...
This handler supports both Action types from the negotiated [Payment Authentication extension](https://sakinaroufid.github.io/pr-test/draft/specification/payment/extensions/authentication/index.md):
...
- **Pattern:** [Tokenization Payment Handler](https://sakinaroufid.github.io/pr-test/draft/specification/payment/guide/index.md)
