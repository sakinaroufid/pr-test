...
The only supported instrument schema is [CardPaymentInstrument](/pr-test/draft/schemas/common/types/card_payment_instrument.json), the only supported checkout credential schema is `EncryptedCredential`, and the only supported source credential schema is [PanCredential](/pr-test/draft/schemas/common/types/pan_credential.json).
...
- **Instrument Schema:** [schemas/common/types/card_payment_instrument.json](/pr-test/draft/schemas/common/types/card_payment_instrument.json)
