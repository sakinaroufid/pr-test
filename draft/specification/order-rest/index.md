...
This document specifies the REST binding for the [Order Capability](https://sakinaroufid.github.io/pr-test/draft/specification/order/index.md).
...
For the Order Event Webhook (business -> platform push), see the [Order Capability overview](https://sakinaroufid.github.io/pr-test/draft/specification/order/#order-event-webhook).
...
Request and response signatures follow the [Message Signatures](https://sakinaroufid.github.io/pr-test/draft/specification/signatures/index.md) specification using RFC 9421 HTTP Message Signatures. See [REST Request Signing](https://sakinaroufid.github.io/pr-test/draft/specification/signatures/#rest-request-signing) and [REST Request Verification](https://sakinaroufid.github.io/pr-test/draft/specification/signatures/#rest-request-verification) for the complete algorithm.
...
- **SHOULD** sign responses per the [Message Signatures](https://sakinaroufid.github.io/pr-test/draft/specification/signatures/index.md) specification

See [Order Capability - Guidelines](https://sakinaroufid.github.io/pr-test/draft/specification/order/#operations-guidelines) for capability-level requirements that apply across all transports.
