...
This document specifies the Model Context Protocol (MCP) binding for the [Order Capability](https://sakinaroufid.github.io/pr-test/draft/specification/order/index.md).
...
The `meta["ucp-agent"]` field is **required** on all requests to enable [capability negotiation](https://sakinaroufid.github.io/pr-test/draft/specification/overview/#negotiation-protocol). Platforms **MAY** include additional metadata fields.
...
| ----------- | ---------------------------------------------------------------------------------------- | ---------------------------------- |
| `get_order` | [Get Order](https://sakinaroufid.github.io/pr-test/draft/specification/order/#get-order) | Get the current state of an order. |

### `get_order`

Maps to the [Get Order](https://sakinaroufid.github.io/pr-test/draft/specification/order/#get-order) operation. Returns the current-state snapshot of an order.
